...
class BidangKajianDialog : BaseDialogFragment<BidangKajianPresenter>(), BidangKajianView {
    ...
    private fun getData() {
        ...
        val data1 = BidangKajian("01", "Politik")
        bidangKajianList.add(data1)
        val data2 = BidangKajian("02", "Ekonomi")
        bidangKajianList.add(data2)
        val data3 = BidangKajian("03", "Hukum")
        bidangKajianList.add(data3)
        val data4 = BidangKajian("04", "HAM")
        bidangKajianList.add(data4)
        val data5 = BidangKajian("05", "Korupsi")
        bidangKajianList.add(data5)
        val data6 = BidangKajian("05", "Terorisme")
        bidangKajianList.add(data6)
        val data7 = BidangKajian("05", "Energi")
        bidangKajianList.add(data7)
        val data8 = BidangKajian("05", "Pangan")
        bidangKajianList.add(data8)
        val data9 = BidangKajian("05", "Infrastruktur")
        bidangKajianList.add(data9)
        val data10 = BidangKajian("05", "Sumber Daya Alam")
        bidangKajianList.add(data10)
        val data11 = BidangKajian("05", "Lingkungan hidup")
        bidangKajianList.add(data11)
        val data12 = BidangKajian("05", "Pendidikan")
        bidangKajianList.add(data12)
        val data13 = BidangKajian("05", "Kesehatan")
        bidangKajianList.add(data13)
        val data14 = BidangKajian("05", "Ketenagakerjaan")
        bidangKajianList.add(data14)
        val data15 = BidangKajian("05", "Sosial dan budaya")
        bidangKajianList.add(data15)
        val data16 = BidangKajian("05", "Budaya")
        bidangKajianList.add(data16)
